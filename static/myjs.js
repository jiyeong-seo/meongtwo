    ...
    success: function (response) {
      if (response["result"] === "success") {
        ...
        for (let i = 0; i < posts.length; i++) {
          ...
          likes_temp_content = likes_temp.slice(0, -9);
          likes_temp = likes_temp_content + `</span>` + comment_temp_test;
...
<div class="content">
  <p>
    ...
    <small class="post-content__username">@${
      post["username"]
    }</small> <small class="post-content__time">${time_before}</small>
    <br />
